...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_EU9A[0xAC];                                  // 0x0000(0x00AC) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_SWRR[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_U99C[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_KU4K[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
