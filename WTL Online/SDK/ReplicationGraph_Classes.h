...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_U80M[0x40];                                  // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MYZV[0x3E0];                                 // 0x00B8(0x03E0) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_AV5M[0x8];                                   // 0x04C8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CDFT[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UFD1[0xA8];                                  // 0x0050(0x00A8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_G6T0[0xE8];                                  // 0x0050(0x00E8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DYNQ[0x30];                                  // 0x00F8(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_G6FM[0x98];                                  // 0x00F8(0x0098) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_E0JC[0x10];                                  // 0x00F8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JAGI[0x48];                                  // 0x00F8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_ZS81[0x1E0];                                 // 0x0050(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QGGI[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TMW6[0x18];                                  // 0x00F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_U7RB[0x18];                                  // 0x0060(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GLZK[0x140];                                 // 0x0030(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FBU0[0x10];                                  // 0x0178(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct FLastLocationGatherInfo>                     LastGatherLocations;                                     // 0x0188(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_XHKH[0x8];                                   // 0x0198(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SBWS[0x80];                                  // 0x01B8(0x0080) MISSED OFFSET (PADDING)
