...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_W8LC[0x27];                                  // 0x0031(0x0027) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BB3O[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
