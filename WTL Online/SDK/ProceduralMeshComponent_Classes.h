...
namespace CG
{
	 ...
	 * Size -> 0x0064 (FullSize[0x04D0] - InheritedSize[0x046C])
	 */
	class UProceduralMeshComponent : public UMeshComponent
	{
	public:
		unsigned char                                              UnknownData_180U[0x4];                                   // 0x046C(0x0004) Fix Super Size
		...
		unsigned char                                              UnknownData_UW3R[0x6];                                   // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3PKU[0x4];                                   // 0x04BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
