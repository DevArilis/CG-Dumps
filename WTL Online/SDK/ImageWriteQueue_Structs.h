...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TVS9[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M7J1[0x46];                                  // 0x001A(0x0046) MISSED OFFSET (PADDING)
	};
