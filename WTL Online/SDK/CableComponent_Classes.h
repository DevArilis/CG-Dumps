...
namespace CG
{
	 ...
	 * Size -> 0x0094 (FullSize[0x0500] - InheritedSize[0x046C])
	 */
	class UCableComponent : public UMeshComponent
	{
	public:
		unsigned char                                              UnknownData_0Z9L[0x4];                                   // 0x046C(0x0004) Fix Super Size
		...
		unsigned char                                              UnknownData_Y48Q[0x3];                                   // 0x04C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WNQU[0x1C];                                  // 0x04E4(0x001C) MISSED OFFSET (PADDING)
